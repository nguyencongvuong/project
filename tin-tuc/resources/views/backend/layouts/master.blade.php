...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{$backend}}/js/gritter/css/jquery.gritter.css" />
    <link rel="stylesheet" type="text/css" href="{{$backend}}/lineicons/style.css">    
  ...
  <section id="container" >
    ...
    <script src="{{$backend}}/js/jquery.sparkline.js"></script>


    <!--common script for all pages-->
    <script src="{{$backend}}/js/common-scripts.js"></script>
    
    <script type="text/javascript" src="{{$backend}}/js/gritter/js/jquery.gritter.js"></script>
    <script type="text/javascript" src="{{$backend}}/js/gritter-conf.js"></script>

    <!--script for this page-->
    <script src="{{$backend}}/js/sparkline-chart.js"></script>    
  <script src="{{$backend}}/js/zabuto_calendar.js"></script>  
